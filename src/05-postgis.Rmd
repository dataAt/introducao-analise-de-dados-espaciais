...
Observe que para inserir a geolocalização de cada rede de detecção foi utilizada
uma síntaxe bem peculiar. Esse formato diz respeito ao  WKT (*Well-known text*),
uma linguagem de marcação de texto para trabalhar com objetos geometricas. 
